...
// ;(function($, window, document, undefined){
    ...
    jQuery(document).ready(function(){
        ...
        /********************     HERO SLIDES     *********************/
        var heroSlides                  = $('#slider li');

        if (heroSlides.length > 1) {
            var heroNav                 = $('#bullets a');
            var heroSlider              = new $.UB.Slideshow(heroSlides);
